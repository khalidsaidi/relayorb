...
# ============
DEMO_PROJECT_ID="relayorb-demo"
AR_LOCATION="us-central1"   # must match the docker host used (e.g., us-central1-docker.pkg.dev)
AR_REPO="relayorb"          # must match the repo segment in image URLs
...
DEMO_GH_DEPLOYER_SA_EMAIL="REPLACE_ME_WITH_DEPLOY_DEMO_SERVICE_ACCOUNT"
