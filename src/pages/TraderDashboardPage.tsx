...
function buildAiPrompt(params: {
  ...
  lines.push(
    [
      ...
      "PASS 2) If your environment supports browsing/opening links, research the missing facts from primary sources (SEC EDGAR links included below, company IR, reputable financial news, exchange data).",
      "",
      "Hard rules:",
